            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    ...
                    <div class="div_design">
                        ...
                        <input class="text_color" type="text"  value="{{$product->price}}" name="price" placeholder="write a price">
                    </div>
                    <div class="div_design">
                        <label for="">Product Discount price  :</label>
                        <input class="text_color" type="text" value="{{$product->discount_price}}" name="discount" placeholder="write a discount price">
                    </div>
                    <div class="div_design">
                        <label for="">Product Quantity :</label>
                        <input class="text_color" type="text" value="{{$product->quantity}}" name="quantity" placeholder="write a quantity">
                    </div>
                    <div class="div_design">
                    ...
                    <div class="div_design">
                       ...
                       <img height="100px;" width="100px" style="margin-left:50px;" src="/products/{{$product->image}}" alt="">
                    </div>
