...
<div class="container">
    ...
    <h1 class="center">Payment Gateway</h1>
                    ...
                    <form 
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12  form-group cvc required'>
                                <label class=' form-row control-label'>CVC</label> <input autocomplete='off'
                        ...
                        <div class='col-xs-12 form-group expiration required'>
                                <label class='form-row control-label'>Expiration Month</label> <input
